...
public class MainTest {
  ...
  private static final String ARGENTINA_METHOD_NAME = "getPricesConvertedForArgentina";
  ...
  @Test
  public void argentinaPriceConverterIsReplaced() throws Exception {
    List<String> statements = Main.getPricesConvertedForArgentina(compositionRecords);

    String msg = String.format("Make sure you swap out the priceConverter argument called within the method '%s'",
      ARGENTINA_METHOD_NAME);
    assertThat(msg, statements.get(0), not(containsString("FIXME")));
  }
